...
RUN wget --progress=dot:giga -O '/comfyui/input/pexels-mimfathi-10919291.jpg' "https://cool-anteater-319.convex.cloud/api/storage/e004cd37-6107-41ac-9594-540fe2517d9d"
RUN wget --progress=dot:giga -O '/comfyui/input/pexels-peterfazekas-1137340.jpg' "https://cool-anteater-319.convex.cloud/api/storage/6f49beb0-253c-4848-8420-8e1f714c6b0b"
RUN wget --progress=dot:giga -O '/comfyui/input/00001-louis-vuitton-spring-2026-menswear-credit-gorunway.jpg.webp' "https://cool-anteater-319.convex.cloud/api/storage/a9fb0591-042e-4c7a-ad1a-aa43d7afdf77"
RUN wget --progress=dot:giga -O '/comfyui/input/pexels-alina-zahorulko-48514961-31445409.jpg' "https://cool-anteater-319.convex.cloud/api/storage/f3b06664-652e-4150-8360-1cf5e32fa5b5"
RUN wget --progress=dot:giga -O '/comfyui/input/6dfa395c67d056ae2e94969e0bf4144b.jpg' "https://cool-anteater-319.convex.cloud/api/storage/aad77b5f-fb69-4fdb-a321-38b9b09be25a"
