# Final_vton_workflow_with_old_models
ComfyUI workflow Dockerized via [comfyui-wizard](https://comfy.getrunpod.io).
Submission: https://comfy.getrunpod.io/dashboard/submissions/kd7185wz0n4z4wa2e4avyxg5en89qhnz
## Pull the prebuilt image

We've already built and published this image on Docker Hub:

```bash
docker pull timpietruskyrunpod/comfyui-wizard:kd7185wz0n4z4wa2e4avyxg5en89qhnz
docker run --rm --gpus all -p 8188:8188 timpietruskyrunpod/comfyui-wizard:kd7185wz0n4z4wa2e4avyxg5en89qhnz
```
